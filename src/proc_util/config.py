...
class Config:
    ...
    prompt: str = (
        ...
        "В ответе дай краткий итог и конкретный вариант ответа. Если в задании "
        "указаны рамки объёма развёрнутого ответа(в том числе нижняя граница), строго соблюдай эти рамки."
    )
    system_prompt: str = (
        ...
        "Если в задании указан лимит слов, символов, предложений, абзацев, строк "
        "или другой объём развёрнутого ответа, соблюдай его точно (в том числе нижние границы)."
    )
    detail: str = "low"
